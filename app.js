//web server to serve HTML files and store retrieving movies functionality
...
function generateCSVandTable(movies) {
    ...
    tableContent +=
        '<div class="table-container"><table border="1" id="byVote"> <tr><th>Movies Sorted by Votes</th></tr>';
    movies.sort((a, b) => {
    ...
    tableContent +=
        '<div class="table-container"><table border="1" id="byAlpha"> <tr><th>Movies Sorted Alphabetically</th></tr>';
    moviesByVote.sort();
    ...
    tableContent +=
        '<div class="table-container"><table border="1" id="byAlpha2"> <tr><th>Movies Sorted Alphabetically (Excluding "A" or "The")</th></tr>';
    movies.sort((a, b) => {
